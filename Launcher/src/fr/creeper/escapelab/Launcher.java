...
public class Launcher {
	...
	public static final GameInfos CA_INFOS = new GameInfos("EscapeLab", CA_VERSION, new GameTweak[] { GameTweak.FORGE });
	...
	public static void update() throws Exception {
		SUpdate su = new SUpdate("https://launcher.escapelab.network/Launcher/", CA_DIR);
			...
			public void run() {
				while (!this.isInterrupted()) {
					if (BarAPI.getNumberOfFileToDownload() == 0) {
						LauncherFrame.getInstance().getLauncherPanel().setInfoText("V�rification...");
						continue;
					}
