...
public class LauncherPanel extends JPanel implements SwingerEventListener
{
   ...
   // private JEditorPane jep;
    ...
    public LauncherPanel()
    {
        ...
        playButton = new STexturedButton(Swinger.getResource("play.png"), Swinger.getResource("play.png"), Swinger.getResource("play.png"));
        ...
        ramButton = new STexturedButton(Swinger.getResource("ram.png"), Swinger.getResource("ram.png"), Swinger.getResource("ram.png"));
        ...
        ramSelector = new RamSelector(new File(Launcher.CA_DIR, "ram.txt"));
      //  jep = new JEditorPane();
        setLayout(null);
        ...
        speudoField.setBounds(241, 181, 494, 85);
        add(speudoField); //speudo crack
        playButton.setBounds(332, 347, 312, 154);
       ...
       // add(Discordbutton);
        ...
        ramButton.setBounds(381, 510, 213, 60);
        add(ramButton);
    }
	...
	public void onEvent(SwingerEvent e) {
		if (e.getSource() == playButton) {
			...
			if(usernameField.getText().length() != 0 && speudoField.getText().length() != 0) { // il y a une email rentr�e et un speudo donc on ne peux savoir si c'est un crack ou un premium
			...
			Thread t = new Thread() {
				...
				public void run() 
				{
					...
					catch (Exception e) 
					{
						...
						LauncherFrame.getCrashReporter().catchError(e, "Erreur, probl�me du Serveur. Peut-�tre en maitnenance ?");
					}
